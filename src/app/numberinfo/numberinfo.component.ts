...
@Component({
  ...
  templateUrl: './numberinfo.component.html',
  styleUrls: ['./numberinfo.component.css']
})
export class NumberinfoComponent extends ActivePageChanger implements OnInit {
  constructor( PageService: ActivePageService ) {
    super('numberinfo', PageService);
  }
